    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Web Suporte - Faça seu cadastro para que possamos<br>te atender!</p>
            </div>
        </header>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-x1-7">
                        <form method="post" action="minha-conta.jsp">
                            ...
                            <br><br>                            
                            <input class="form-control" type="text" name="cpf" placeholder="CPF - 000.000.000-00" required>
                            <br><br>
                            <input class="form-control" type="text" name="email" placeholder="E-mail - email@exemplo.com.br" required>
                            <br><br>
                            <input class="form-control" type="password" name="senha" placeholder="Digite uma senha..." required>
                            <br><br>
                            <button class="btn btn-primary btn-xl" id="submitButton" type="submit">Finalizar Cadastro</button>            
                        </form>
                    </div>
                </div>    
            </div>
